...
export const MISSION_INTEGRATION_LEGAL: readonly LegalVector<MissionState, MissionEvent>[] = [
  ...
  },
  {
    ref: "A.1#3b",
    from: "planned",
    event: { type: "plan-approved", dagAcyclic: true, executionSlotFree: false },
    to: "queued",
  },
  { ref: "A.1#4", from: "planned", event: { type: "plan-rejected" }, to: "draft" },
  {
    ref: "A.1#5",
    from: "queued",
  ...
  },
  {
    ref: "A.1#11",
    from: "awaiting-merge-approval",
    event: { type: "mission-merge-rejected", reason: "rollup incomplete for CAM-VAL-06a" },
    to: "executing",
  },
  {
    ref: "A.1#12",
    from: "merging",
    event: { type: "candidate-rebuilt", green: true, newCandidateSha: "cand-2" },
    to: "awaiting-merge-approval",
  },
  {
    ref: "A.1#13",
  ...
  },
  {
    ref: "A.1#17",
    from: "paused-manual",
    event: { type: "mission-resumed", resumeTo: "executing" },
    to: "executing",
  },
  {
    ref: "A.1#17",
    from: "paused-manual",
    event: { type: "mission-resumed", resumeTo: "draft" },
    to: "draft",
  },
  ...
  { ref: "A.1#24", from: "executing", event: { type: "mission-abandoned" }, to: "abandoned" },
];
...
export const MISSION_INTEGRATION_ILLEGAL: readonly IllegalVector<MissionState, MissionEvent>[] = [
  ...
  },
  {
    ...
    from: "planned",
    event: { type: "plan-approved", dagAcyclic: false, executionSlotFree: true },
    expect: "guard-rejected",
  },
  {
  ...
  },
  {
    ...
    from: "paused-manual",
    event: { type: "mission-resumed", resumeTo: "complete" },
    expect: "guard-rejected",
  },
  {
    name: "resume without recorded prior state",
    from: "paused-manual",
    event: { type: "mission-resumed" },
    expect: "guard-rejected",
  },
  {
  ...
  },
  {
    ...
    from: "executing",
    event: { type: "mission-paused", attemptSettled: false },
    expect: "guard-rejected",
  },
];
...
export const MISSION_QUICK_LEGAL: readonly LegalVector<MissionState, MissionEvent>[] = [
  ...
  },
  {
    ref: "A.1b#8",
    from: "awaiting-merge-approval",
    event: { type: "mission-merge-rejected", reason: "packet incomplete" },
    to: "executing",
  },
  {
    ref: "A.1b#9",
    from: "merging",
    event: { type: "candidate-rebuilt", green: true, newCandidateSha: "qcand-2" },
    to: "awaiting-merge-approval",
  },
  {
    ref: "A.1b#10",
...
export const ISSUE_LEGAL: readonly LegalVector<IssueState, IssueEvent>[] = [
  ...
  },
  {
    ref: "A.2#21a",
    from: "escalated",
    event: { type: "escalation-answered", resolution: "retry" },
    to: "ready",
  },
  {
    ref: "A.2#21b",
    from: "escalated",
    event: { type: "escalation-answered", resolution: "cancel" },
    to: "cancelled",
  },
  { ref: "A.2#22", from: "merge-pending", event: { type: "issue-cancelled" }, to: "cancelled" },
