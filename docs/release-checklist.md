...
| 4 | Threat-model re-pricing for distribution | David | **pending** | T3 residual and post-merge supply-chain risk re-priced for multi-user distribution (design §5.3) |
