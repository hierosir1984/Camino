...
4. Review archaeology: docs/design/06–25 (raw falsification reviews + dispositions, all verbatim).
...
- **The medicine applies to the doctor:** Camino's own PRs get cross-family review; the Phase-0 robustness suites (quarantine, egress/scrubbing, kill-point chaos) persist as CI.
...
3. Quarantine rejection suite — all enumerated cases rejected; persists as CI
4. Untrusted-content robustness baseline — every finding dispositioned
